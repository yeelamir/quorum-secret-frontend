<template>
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        ...
        <button @click="closeEditSecret" class="close-button">&times;</button>
        <h2 class="text-2xl font-semibold text-center text-gray-700 mb-6">Edit Secret</h2>
        ...
        <form @submit.prevent="saveSecret" class="space-y-4">
            ...
            <button type="submit" class="w-full py-3 bg-black text-white rounded-lg hover:bg-gray-800">Update Secret</button>
        </form>
        </div>
    </div>
</template>
